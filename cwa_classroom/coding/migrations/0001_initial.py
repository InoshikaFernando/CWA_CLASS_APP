    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(blank=True, help_text='Icon identifier used in templates', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_results', models.JSONField(
                    blank=True,
                    default=list,
                    help_text='List of dicts: {test_case_id, is_visible, passed, actual_output, expected_output}. actual_output is only stored for visible test cases.',
                )),
                ...
                ('student', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='coding_problem_submissions',
                    to=settings.AUTH_USER_MODEL,
                )),
            ],
            options={
