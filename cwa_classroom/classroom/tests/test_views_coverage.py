...
class HomeViewTests(TestCase):
    ...
    def test_admin_redirect(self):
        user = CustomUser.objects.create_user('admin1', 'a@t.com', 'pass12345')
    ...
    def test_hoi_redirect(self):
        user = CustomUser.objects.create_user('hoi1', 'h@t.com', 'pass12345')
    ...
    def test_teacher_redirect(self):
        user = CustomUser.objects.create_user('teach1', 't@t.com', 'pass12345')
    ...
    def test_accountant_redirect(self):
        user = CustomUser.objects.create_user('acc1', 'acc@t.com', 'pass12345')
        _assign_role(user, Role.ACCOUNTANT)
        self.client.login(username='acc1', password='pass12345')
        resp = self.client.get(reverse('home'))
        self.assertEqual(resp.status_code, 302)
        self.assertIn('accounting', resp.url)

    def test_parent_redirect(self):
        user = CustomUser.objects.create_user('parent1', 'p@t.com', 'pass12345')
    ...
    def test_institute_owner_redirect(self):
        user = CustomUser.objects.create_user('owner1', 'o@t.com', 'pass12345')
    ...
    def test_superuser_no_role_redirects_to_django_admin(self):
        user = CustomUser.objects.create_superuser('su', 'su@t.com', 'pass12345')
...
class PublicHomeViewTests(TestCase):
    ...
    def test_authenticated_admin_redirects(self):
        user = CustomUser.objects.create_user('a', 'a@t.com', 'pass12345')
        _assign_role(user, Role.ADMIN)
    ...
    def test_authenticated_teacher_redirects(self):
        user = CustomUser.objects.create_user('t', 't@t.com', 'pass12345')
        _assign_role(user, Role.TEACHER)
...
class TopicsViewTests(TestCase):
    ...
    def test_topics_returns_200(self):
        user = CustomUser.objects.create_user('u', 'u@t.com', 'pass12345')
...
class RoleRequiredMixinTests(TestCase):
    ...
    def setUp(self):
        self.user = CustomUser.objects.create_user('u', 'u@t.com', 'pass12345')
...
class HoDOverviewViewTests(TestCase):
    ...
    def test_hod_can_access_dashboard(self):
        hod = CustomUser.objects.create_user('hod1', 'hod1@t.com', 'pass12345')
    ...
    def test_student_cannot_access(self):
        student = CustomUser.objects.create_user('s', 's@t.com', 'pass12345')
        _assign_role(student, Role.STUDENT)
        self.client.login(username='s', password='pass12345')
        resp = self.client.get(reverse('hod_overview'))
        self.assertEqual(resp.status_code, 302)
...
class AccountingDashboardViewTests(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = CustomUser.objects.create_user('acc', 'acc@t.com', 'pass12345')
...
class BulkStudentRegistrationViewTests(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.teacher = CustomUser.objects.create_user('teacher', 'tc@t.com', 'pass12345')
    ...
    def test_post_bulk_register(self):
        ...
        resp = self.client.post(reverse('bulk_student_registration'), {
            'students_data': 'bulkuser1,bulk1@test.com,password123\nbulkuser2,bulk2@test.com,password456',
        })
        self.assertEqual(resp.status_code, 200)
...
class AdminDashboardViewTests(TestCase):
    ...
    def test_admin_can_access(self):
        admin = CustomUser.objects.create_user('admin2', 'admin2@t.com', 'pass12345')
...
class SchoolDetailViewTests(TestCase):
    ...
    def test_other_user_cannot_access(self):
        other = CustomUser.objects.create_user('other', 'other@t.com', 'pass12345')
...
class ManageRedirectViewTests(TestCase):
    ...
    def test_manage_teachers_redirect_no_school(self):
        ...
        user = CustomUser.objects.create_user('noschool', 'ns@t.com', 'pass12345')
        _assign_role(user, Role.HEAD_OF_INSTITUTE)
...
class SchoolTeacherManageViewTests(TestCase):
    ...
    def test_post_create_teacher(self):
        ...
        self.assertEqual(resp.status_code, 302)
        self.assertTrue(CustomUser.objects.filter(email='jane@test.com').exists())
        self.assertTrue(
            SchoolTeacher.objects.filter(school=self.school, teacher__email='jane@test.com').exists()
        )
...
class SchoolStudentManageViewTests(TestCase):
    ...
    def test_post_create_student(self):
        ...
        self.assertEqual(resp.status_code, 302)
        self.assertTrue(CustomUser.objects.filter(email='alice@test.com').exists())
        self.assertTrue(
            SchoolStudent.objects.filter(school=self.school, student__email='alice@test.com').exists()
        )
